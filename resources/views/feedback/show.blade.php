        ...
        <div class="p-6 relative">
            ...
            <form id="feedbackForm">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="feedback_content" id="feedbackContent" class="mt-2 text-[14px] text-gray-600 w-full border border-gray-200 p-2 rounded" rows="8" required></textarea>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg p-6">
                {{-- <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('orders.index') }}" class="btn bg-[#164272] text-white border-0 py-3 px-5 h-auto min-h-0">Back</a>
                </div> --}}
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-[#164272]">Reference No: {{ $order->reference_number }}</h3>
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('feedback.index') }}" class="btn bg-[#164272] text-white border-0 py-3 px-5 h-auto min-h-0">Back</a>
                        @endif
                    </div>
                </div>
                <hr />
                {{-- <div class="img-trackbox">
                    <div class="img-track track1">
                        <img src="{{ asset('assets/images/ico1.png') }}" class="img1">
                        <p class="text-[#164272]">Placed Order</p>
                    </div>
