    ...
    <x-modal name="feedback-modal" maxWidth="lg" focusable>
        <div class="p-6 relative">
            ...
            <form id="feedbackForm">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium">Customer Feedback*</label>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium">Feedback On Driver*</label>
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('deliver.order.index') }}" class="btn bg-[#164272] text-white border-0 py-3 px-5 h-auto min-h-0">Back</a>
                    </div>
                </div>
                <hr />
                ...
                <div class="mt-4 border p-4 rounded-lg">
                    ...
                    <p class="text-gray-800 mb-2"><strong>Status:</strong> {{ ucfirst($order->order_status) }}</p>
                ...
                <div class="mt-8 border p-4 rounded-lg">
                    <h1 class="text-gray-800 text-[18px] mb-2"><strong>Customer Details</strong></h1>
                    <hr />
                    <div class="flex items-center mt-4">
                        @if($order->customer && $order->customer->profile_image)
                            <div class="mt-3 mb-3 border p-2 rounded-lg w-fit">
                                <img src="{{ Storage::url($order->customer->profile_image) }}" width="100" class="rounded" />
                            </div>
                        @endif
                        <div class="pl-4">
                            <p class="text-gray-800 mb-2"><strong>Name:</strong> {{ $order->customer->name ?? '-' }}</p>
                            <p class="text-gray-800 mb-2"><strong>Email:</strong> {{ $order->customer->email ?? '-' }}</p>
                            <p class="text-gray-800 mb-2"><strong>Phone Number:</strong> {{ $order->customer->phone_number ?? '-' }}</p>
                            {{-- Add any other fields like address, etc. if available --}}
                        </div>
                    </div>
                </div>
