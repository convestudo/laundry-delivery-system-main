            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <form action="{{ route('roomreservations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-control w-full mb-4">
                        ...
                        <input type="text" name="room_name" class="input input-bordered w-full"
                            placeholder="Enter room name" value="{{ $room->name }}" readonly>
                    </div>
                    @error('room_name')
                    ...
                    <div class="form-control w-full mb-4">
                        ...
                        <input type="number" name="participant" class="input input-bordered w-full"
                            placeholder="Enter participant" value="{{ old('participant') }}">
                    </div>
                    @error('participant')
                        <div class="alert alert-error">
                            {{ $message }}
